...
class model extends \PDO{
    public function __construct()
    {
        ...
        $options = array(
            ...
            PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES UTF8MB4,SQL_MODE="STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION"',
